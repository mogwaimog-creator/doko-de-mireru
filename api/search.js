...
//
// ※ ABEMAの無料判定は、
//   TMDBにABEMA情報が存在しない場合でも
//   登録作品リストから判定できるようにしています。
// =========================================================
...
//
// 注意:
// ABEMAの無料配信は作品ごと・時期ごとに変わるため、
// ここは後から追加・変更できるようにしています。
//
// 今回は確認したい
// 「エイリアン・ハンティング」
// を登録しています。
...
function isAbemaFreeMovie(
  ...
  for (
    ...
    if (
      registeredTitle === title1 ||
      registeredTitle === title2
    ) {
